    ...
    <div class="w-full max-w-4xl mx-auto bg-white border border-gray-200 rounded-[30px] p-16 shadow-[0_15px_40px_-20px_rgba(0,0,0,0.1)]">
        ...
        <div class="flex items-center gap-6 mb-16">
            ...
            <div>
                ...
                <p class="text-[#0066FF] text-[13px] font-medium lowercase">user</p>
            </div>
        </div>
        ...
        <form action="{{ route('profile.update') }}" method="POST" class="max-w-2xl mx-auto space-y-6">
            ...
            <div class="pt-10">
                <button type="submit" 
                        class="w-full bg-[#0055FF] text-white py-3.5 rounded-xl font-bold text-[15px] flex items-center justify-center gap-3 shadow-lg shadow-blue-100">
